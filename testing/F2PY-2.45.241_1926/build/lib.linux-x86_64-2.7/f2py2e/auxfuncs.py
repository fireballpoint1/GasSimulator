...
$Date: 2004/11/13 21:43:46 $
Pearu Peterson
"""
__version__ = "$Revision: 1.61 $"[10:-1]
...
def isoptional(var): return (var.has_key('attrspec') and 'optional' in var['attrspec'] and 'required' not in var['attrspec'])
def isexternal(var): return (var.has_key('attrspec') and 'external' in var['attrspec'])
def isrequired(var): return not isoptional(var)
def isintent_in(var):
